...
//go:generate minimock -i github.com/escoutdoor/kotopes/common/pkg/db.TxManager -o tx_manager_mock.go -n TxManagerMock -p mocks
...
type TxManagerMock struct {
	...
	funcReadCommitted          func(ctx context.Context, fn func(ctx context.Context) error) (err error)
	funcReadCommittedOrigin    string
	inspectFuncReadCommitted   func(ctx context.Context, fn func(ctx context.Context) error)
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Expect(ctx context.Context, fn func(ctx context.Context) error) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) ExpectFnParam2(fn func(ctx context.Context) error) *mTxManagerMockReadCommitted {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
	...
	mmReadCommitted.defaultExpectation.expectationOrigins.originFn = minimock.CallerInfo(1)

	return mmReadCommitted
}

// Inspect accepts an inspector function that has same arguments as the TxManager.ReadCommitted
func (mmReadCommitted *mTxManagerMockReadCommitted) Inspect(f func(ctx context.Context, fn func(ctx context.Context) error)) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Set(f func(ctx context.Context, fn func(ctx context.Context) error) (err error)) *TxManagerMock {
	if mmReadCommitted.defaultExpectation != nil {
...
// Then helper
func (mmReadCommitted *mTxManagerMockReadCommitted) When(ctx context.Context, fn func(ctx context.Context) error) *TxManagerMockReadCommittedExpectation {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
...
func (mmReadCommitted *TxManagerMock) ReadCommitted(ctx context.Context, fn func(ctx context.Context) error) (err error) {
	...
	if mmReadCommitted.ReadCommittedMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fn != nil && !minimock.Equal(*mm_want_ptrs.fn, mm_got.fn) {
				mmReadCommitted.t.Errorf("TxManagerMock.ReadCommitted got unexpected parameter fn, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmReadCommitted.ReadCommittedMock.defaultExpectation.expectationOrigins.originFn, *mm_want_ptrs.fn, mm_got.fn, minimock.Diff(*mm_want_ptrs.fn, mm_got.fn))
			}
