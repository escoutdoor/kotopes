...
const (
	AccessV1_CheckIsAllowed_FullMethodName = "/AccessV1/CheckIsAllowed"
)
...
type AccessV1Client interface {
	...
	CheckIsAllowed(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckResponse, error)
}
...
func (c *accessV1Client) CheckIsAllowed(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckResponse)
	err := c.cc.Invoke(ctx, AccessV1_CheckIsAllowed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccessV1Server interface {
	// Checks if a user has access to the resource
	CheckIsAllowed(context.Context, *CheckRequest) (*CheckResponse, error)
...
func (UnimplementedAccessV1Server) CheckIsAllowed(context.Context, *CheckRequest) (*CheckResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckIsAllowed not implemented")
}
...
func _AccessV1_CheckIsAllowed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccessV1Server).CheckIsAllowed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccessV1_CheckIsAllowed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccessV1Server).CheckIsAllowed(ctx, req.(*CheckRequest))
	}
...
var AccessV1_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "AccessV1",
	HandlerType: (*AccessV1Server)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CheckIsAllowed",
			Handler:    _AccessV1_CheckIsAllowed_Handler,
		},
	},
